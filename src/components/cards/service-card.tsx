...
const ServiceCard: React.FC<ServiceCardProps> = ({ data }) => (
	...
	>
		...
		<p className="text-sm text-[#7C6F6F] mb-6">{data.desc}</p>
		   <button
			   className="mt-auto flex cursor-pointer items-center gap-1 text-sm font-medium text-black border rounded-full px-4 py-2 hover:bg-black hover:text-white transition"
