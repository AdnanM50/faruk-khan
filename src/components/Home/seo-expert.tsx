      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {platforms.map((platform) => (
            <div
              key={platform.title}
              className={`flex flex-col h-full rounded-2xl border hover:border-black hover:shadow-[0_2px_16px_0_rgba(0,0,0,0.04)] px-7 py-10 items-center transition-shadow duration-200 border-[#E2DADA]`}
            >
              ...
              <button className={`mt-auto flex items-center gap-1 text-sm font-medium rounded-full px-4 py-2 transition border hover:bg-black hover:text-white`}>
